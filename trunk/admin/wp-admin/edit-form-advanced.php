...
<div id="titlediv">
<div id="titlewrap" style="bottom: 12px;position: relative;">
	<?php
	/**
	...
	<textarea name="post_subtitle" placeholder="This is sub-discription" size="30"  id="subtitle" autocomplete="off" style="height: 93px;display: block;position: relative;top: 17px;width: 100%;">
		<?php echo esc_attr( htmlspecialchars( $post->post_subtitle ) ); ?>
	</textarea>
	<script>
		var html = jQuery("#subtitle").html().trim();
